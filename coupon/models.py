...
class CouponManager(models.Manager):
    def create_coupon(self, type, value, users=[], valid_until=None, prefix="", campaign=None, user_limit=None,min_no_of_item=None,max_discount=None):
        coupon = self.create(
            value=value,
...
class Coupon(models.Model):
    ...
    user_limit = models.PositiveIntegerField(_("User limit"), default=0)
    per_user_limit = models.PositiveIntegerField(_("Per User limit"), default=1)
    ...
    min_no_of_item = models.PositiveIntegerField(_("Minimum Number Of Item"), default=0)
    max_discount = models.PositiveIntegerField(_("Maximum Discount"), default=0)
...
class CouponUser(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Coupon User")
