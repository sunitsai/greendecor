    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'payment_not_done', b'PAYMENT NOT DONE'), (b'payment_done', b'PAYMENT DONE'), (b'order_placed', b'ORDER PLACED'), (b'pending_customer_approval', b'PAINDING CUSTOMER APPROVAL'), (b'customer_approval_done', b'CUSTOMER_APPROVAL_DONE'), (b'in_process', b'IN PROCESS'), (b'dispatched', b'Dispatched'), (b'canceled', b'Canceled'), (b'delivered', b'DELIVERED')], default=b'payment_not_done', editable=False, max_length=50)),
                ...
                ('plant_details', jsonfield.fields.JSONField(default=dict)),
                ...
                ('delivery_date', models.DateField(default=datetime.datetime(2017, 4, 26, 11, 2, 43, 214696))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('max_amount', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(100), django.core.validators.MaxValueValidator(500)], verbose_name=b'Maximum amount for delivery charge')),
                ('delivery_charge', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(20), django.core.validators.MaxValueValidator(150)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[(b'Plants', b'Plants'), (b'Seeds', b'Seeds'), (b'Pots', b'Pots'), (b'Tools', b'Tools'), (b'Fertilizers', b'Fertilizers'), (b'Soil', b'Soil'), (b'Organic Compose', b'Organic Compose')], default=b'Plants', max_length=50)),
                ...
                ('pot_size_min', models.PositiveIntegerField(choices=[(4, b'4"'), (5, b'5"'), (6, b'6"'), (7, b'7"'), (8, b'8"'), (9, b'9"'), (10, b'10"'), (11, b'11"'), (12, b'12"'), (13, b'13"'), (14, b'14"'), (15, b'15"'), (16, b'16"'), (17, b'17"'), (18, b'18"'), (19, b'19"'), (20, b'20"'), (21, b'21"'), (22, b'22"'), (23, b'23"'), (24, b'24"'), (25, b'25"'), (26, b'26"')], default=4)),
                ('pot_size_max', models.PositiveIntegerField(choices=[(4, b'4"'), (5, b'5"'), (6, b'6"'), (7, b'7"'), (8, b'8"'), (9, b'9"'), (10, b'10"'), (11, b'11"'), (12, b'12"'), (13, b'13"'), (14, b'14"'), (15, b'15"'), (16, b'16"'), (17, b'17"'), (18, b'18"'), (19, b'19"'), (20, b'20"'), (21, b'21"'), (22, b'22"'), (23, b'23"'), (24, b'24"'), (25, b'25"'), (26, b'26"')], default=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveIntegerField(choices=[(1, b'1'), (2, b'2'), (3, b'3'), (4, b'4'), (5, b'5')], default=b'5')),
        ...
        migrations.AddField(
            model_name='category',
            name='thumbnail',
            field=models.ImageField(default=b'images/product-image.jpg', upload_to=b'images/'),
        ),
        migrations.AddField(
            model_name='category',
            name='video_url',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.MaintenanceLevel'),
        ),
        migrations.AddField(
            model_name='plants',
            name='price_category',
